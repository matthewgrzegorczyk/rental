...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.rented_on'
        db.alter_column(u'items_item', 'rented_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Item.rented_to'
        db.alter_column(u'items_item', 'rented_to', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.rented_on'
        db.alter_column(u'items_item', 'rented_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Item.rented_to'
        db.alter_column(u'items_item', 'rented_to', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'items.item': {
            ...
            'rented_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'rented_to': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),

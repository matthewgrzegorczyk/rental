...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'items_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'items', ['Tag'])
        ...
        db.create_table(u'items_item', (
            ...
            ('rented_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rented_by', null=True, to=orm['auth.User'])),
            ('rent_power', self.gf('django.db.models.fields.SmallIntegerField')(default=50)),
            ('vision_power', self.gf('django.db.models.fields.SmallIntegerField')(default=50)),
        ))
        db.send_create_signal(u'items', ['Item'])

        # Adding M2M table for field tags on 'Item'
        m2m_table_name = db.shorten_name(u'items_item_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'items.item'], null=False)),
            ('tag', models.ForeignKey(orm[u'items.tag'], null=False))
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'items_tag')

        # Deleting model 'Item'
        db.delete_table(u'items_item')

        # Removing M2M table for field tags on 'Item'
        db.delete_table(db.shorten_name(u'items_item_tags'))

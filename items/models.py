...
class Item(models.Model):
    ...
    added_on = models.DateTimeField(verbose_name="Added on", default=datetime.datetime.now)
    last_modified = models.DateTimeField(verbose_name="Modified on", editable=False, default=datetime.datetime.now)
    rented_on = models.DateTimeField(verbose_name="Rented On", default=datetime.datetime.now)
    rented_to = models.DateTimeField(verbose_name="Rented To", default=datetime.datetime.now)
